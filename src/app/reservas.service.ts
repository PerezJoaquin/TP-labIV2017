...
/*
  ...
  reser(fecha:string, userid:number, descripcion:string, idlocal: string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/reservar', {fecha, userid, descripcion, idlocal})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerLocales(){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.get('http://localhost/pizzeria/index.php/locales')
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerReservas(userid:string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/reservas', {userid})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerOfertasuser(userid:string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/opofer', {userid})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  guardarOpOferta(iditem:string, userid:string, lat, long){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/guardarop', {iditem, userid, tipo:'oferta', lat, long})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  guardarOpProducto(iditem:string, userid:string, fireid:string, lat:string, long:string){
    return this.http.post('http://localhost/pizzeria/index.php/guardarop', {iditem, userid, tipo:'producto', fireid, lat, long})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerOfertasId(id:string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/oferta', {id})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerProductos(){
    this.headers = new Headers({'Content-Type': 'application/json'});
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.get('http://localhost/pizzeria/index.php/productos')
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerOperaciones(){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/operaciones', {PH:'ph'})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  guardarProducto(nombre:string, precio, imagen:string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/guardaprod', {nombre, precio, imagen})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  traerProductosUser(userid:string){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/opprod', {userid})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  guardarOferta(precio, local, limite, descripcion){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/guardarof', {precio, local, limite, descripcion})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  actualizarLocal(id, local){
    ...
    return this.http.post('http://localhost/pizzeria/index.php/localmod', {id, nombre:local.nombre, 
                          direccion:local.direccion, imagen1:local.imagen1, imagen2:local.imagen2,
                          imagen3:local.imagen3, latitud:local.latitud, longitud:local.longitud})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  guardarLocal(nombre, direccion, latitud, longitud, img1, img2, img3){
    this.headers = new Headers({ 'Content-Type': 'application/json' });
    this.options = new RequestOptions({ headers: this.headers });
    return this.http.post('http://localhost/pizzeria/index.php/guardarlocal', {nombre, direccion, latitud, longitud, img1, img2, img3})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  ModOp(id, iditem, userid, tipo, fireid, lat, long, estado){
    return this.http.post('http://localhost/pizzeria/index.php/modop', {id, iditem, userid, tipo, fireid, lat, long, estado})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  modProd(id, nombre, precio, imagen){
    return this.http.post('http://localhost/pizzeria/index.php/prodmod', {id, nombre, precio, imagen})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
  ...
  modOfer(id, precio, local, limite, descripcion){
    return this.http.post('http://localhost/pizzeria/index.php/ofermod', {id, precio, local, limite, descripcion})
    .toPromise()
    .then(this.extraer)
    .catch(this.error);
  }
